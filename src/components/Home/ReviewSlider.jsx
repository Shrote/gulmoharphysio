...
const reviews = [
  {
    ...
    "author": {
      ...
      "reviews": 8,
      "photos": 4,
      "image": "https://lh3.googleusercontent.com/a/ACg8ocJBV9yKJB8bbW1ZmOXX1PLmuRgCdNAVGsc7tvrlkiVWoFDrYLhF=w45-h45-p-rp-mo-br100",
    }
  },
  // {
  //   "id": 2,
  ...
  // },
  {
    ...
    "author": {
      ...
      "reviews": 1,
      "image": "https://lh3.googleusercontent.com/a/ACg8ocKnLc79NIE3GTxPPF71peWD__7ls8Z1GPj7vieUvlOXe2YvHw=w45-h45-p-rp-mo-br100"
    }
  },
  {
    "id": 4,
    ...
    "author": {
      ...
      "reviews": 1,
      "image": "https://lh3.googleusercontent.com/a/ACg8ocJoOgHYXgIlh8X2KQlpc2spohcJPDmCgcPBqTIjE_o9r5Xigg=w45-h45-p-rp-mo-br100"
    }
  },
  {
    "id": 5,
    ...
    "author": {
      ...
      "reviews": 20,
      "photos": 2,
      "image": "https://lh3.googleusercontent.com/a/ACg8ocK9sD4_9q9BKQOWGtIvrbNBVCeLgix7umsZp35Ix8_s6JwaslI=w45-h45-p-rp-mo-ba3-br100"
    }
  },
  {
    "id": 6,
    ...
    "author": {
      "name": "Amarnath Dev",
      "reviews": 18,
      "image": "https://lh3.googleusercontent.com/a-/ALV-UjXOCW4i9YiA8n0U3J_TvMnvZqEalpKtEY0jwlrpIpMYN9Wl5Ipk=w45-h45-p-rp-mo-ba2-br100"
    }
  },
  {
    "id": 7,
    ...
    "author": {
      "name": "Anup Panday",
      "reviews": 1,
      "image": "https://lh3.googleusercontent.com/a/ACg8ocKddndhhnfFEphnNOcLrsrxJixuLu6S9TRWLiUDEvv0Y8DvBg=w45-h45-p-rp-mo-br100"
    }
  },
  {
    "id": 8,
    ...
    "author": {
      "name": "Arun Magesh",
      "image": "https://lh3.googleusercontent.com/a-/ALV-UjWOEYUIrjgQxu__9eqYxEv5vLku3Q2TgG9yl0Qb0uHY479DONs=w45-h45-p-rp-mo-br100"
    }
  },
  {
    "id": 9,
    ...
    "author": {
      "name": "Shubham Kumar",
      "image": "https://lh3.googleusercontent.com/a/ACg8ocLPrDgdRYPeRYC_M7Ll-x9sgczLxBiTC0Fdn1--ZHl773wUaA=w45-h45-p-rp-mo-br100"
    }
  },
  {
    "id": 10,
    ...
    "author": {
      "name": "Ranjan Kumar",
      "image": "https://lh3.googleusercontent.com/a/ACg8ocKVjTn0S-WNV6UxDW66oYDyEHt4y_dsqaHHKKFjkOL-BZ5sPQ=w45-h45-p-rp-mo-br100"
    }
  },
  {
    "id": 11,
    ...
    "author": {
      "name": "Prep Aud",
      "image": "https://lh3.googleusercontent.com/a/ACg8ocJimSnFzEHE1D1-xu6KCQGZcpooGT5sRAVn3hItZ5WQsJOsgA=w45-h45-p-rp-mo-br100"
    }
  },
  {
    "id": 12,
    ...
    "author": {
      ...
      "reviews": 27,
      "photos": 36,
      "image": "https://lh3.googleusercontent.com/a-/ALV-UjVC_nHR1h_zLMfGxaK5X27bYbgezgEiYnLxM68LmhF4Htrtw24Z=w45-h45-p-rp-mo-ba3-br100"
    }
  },
  {
    "id": 13,
    ...
    "author": {
      ...
      "reviews": 2,
      "photos": 13,
      "image": "https://lh3.googleusercontent.com/a-/ALV-UjVf1jZeuDsT_e-zmSOnaB9s0FzIHGPXjjVJ8K2MAb7RBlCNUnI=w45-h45-p-rp-mo-br100"
    }
  },
  {
    "id": 14,
    ...
    "author": {
      "name": "Kamlesh Singh",
      "photos": 2,
      "image": "https://lh3.googleusercontent.com/a-/ALV-UjXbTjcowy3GsSnl7tfOJhO033vcUK4FX8P7pn4pMWJoPg-SP6A=w45-h45-p-rp-mo-br100"
    }
  }
]
...
export default function ReviewSlider() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentIndex((prevIndex) => (prevIndex === reviews.length - 2 ? 0 : prevIndex + 1))
    }, 5000)
  ...
  const handlePrevious = () => {
    setCurrentIndex((prevIndex) => (prevIndex === 0 ? reviews.length - 2 : prevIndex - 1))
  }
  ...
  return (
    <section className={styles.reviewSection}>
      ...
      <div className={styles.reviewSlider} style={{ transform: `translateX(-${currentIndex * (100 / 2)}%)` }}>
        {reviews.map((review) => (
          <div key={review.id} className={styles.reviewCard}>
            <div className={styles.reviewDate}>{review.date}</div>
            <div className={styles.reviewStars}>
              {[...Array(5)].map((_, index) => (
                <Star key={index} className={index < review.rating ? styles.starFilled : ""} size={20} />
              ))}
            </div>
            <p className={styles.reviewText}>{review.text}</p>
            <div className={styles.reviewProfile}>
              <img
                src={review.author.image || "https://www.shutterstock.com/image-vector/avatar-gender-neutral-silhouette-vector-600nw-2470054311.jpg"}
      ...
      <button className={`${styles.sliderNav} ${styles.prev}`} onClick={handlePrevious} aria-label="Previous review">
        <ChevronLeft size={24} />
      </button>
      <button className={`${styles.sliderNav} ${styles.next}`} onClick={handleNext} aria-label="Next review">
